<script setup>
    ...
    // Creamos/Nombramos función
    const totalPagar = computed (()=>{
        // Se evaluará sobre "carrito" con el array method "reduce"
        // Total será el acumulador
                ...
                <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
                    ...
                    >
                        ...
                        <div id="carrito" class="bg-white p-3">
                            <!--En la directiva V-IF, se utiliza el STATE "carrito"-->
                            <p v-if="carrito.length === 0" class="text-center" style="margin: 0;">
                            ...
                            <div v-else>
                                <table class="w-100 table">
                                    ...
                                    <tbody>
                                        <!-- Producto es el objeto temporal se que va a crear mientras se ejecuta el vódigo de v-for -->
                                         <!-- Carrito es el prop o state -->
                                        <tr
                                            v-for="producto in carrito"
                                        >
                                            <!-- Los dos puntos (:src) hacen a src un atributo dinámico-->
                                            <td>
                                                <img 
                                                class="img-fluid" 
